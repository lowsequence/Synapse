...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.first_page_button.emoji = kwargs.get('first_button_emoji') or '<:DoubleLeft:1469267782184206442>'
        self.previous_page_button.emoji = kwargs.get(
            'previous_button_emoji') or '<:LeftArrow:1469267806150463488>'
        self.next_page_button.emoji = kwargs.get('next_button_emoji') or '<:rightarrow:1469267754409529394>'
        self.last_page_button.emoji = kwargs.get('last_button_emoji') or '<:doubleright:1469267725103927316>'
        self.stop_button.emoji = kwargs.get(
            'stop_button_emoji') or '<:close:1469267685714956290>'
        ...
        self.stop_button.style = kwargs.get(
            'stop_button_style') or ButtonStyle.secondary
